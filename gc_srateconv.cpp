...
//v1.10		04-apr-2026			//changed 'qdss_resample_float_continuous()' to use only float calcs
...
for ( i = -( half_wnd ); i <= ( half_wnd - 1 ); i++ ) 						//for 1 window width
    ...
    r_w = 0.5f - 0.5f * cosf( ftwopi * ( 0.5f + ( j - x ) / wnwdth ) );			//make a Hann sample, will be used taper sinc's impulse response length
