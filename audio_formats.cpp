/*
Copyright (C) 2015-2026 BrerDawg, et. al.
...
//v1.11	---- 27-mar-2026				//moded save_wav_malloc() to support 8-bit and 16-bit output via af.bits_per_sample
...
//be aware vector<double> vars are used here, and there is a limit to how big these can grow, so large audio files would to cause a hard to
