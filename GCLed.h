...
#include "GCProfile.h"
#include <FL/Fl_Group.H>												//v1.15

using namespace std;

#define cnMaxColIndex 32
...
int idelta_g;
int idelta_b;
int ioverride_r;					//see 'override_col()'
int ioverride_g;
int ioverride_b;
...
~GCLed();
int SetColIndex(int uiIndex,int iRin,int iGin,int iBin);
int GetColIndex();
...
void set_index_col_rgb( int idx, uint8_t rr, uint8_t gg, uint8_t bb );	//v1.13
...
void override_col( int rr, int gg, int bb );			//v1.12
